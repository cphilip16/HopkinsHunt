...
export const SUBRANKS: Subrank[] = [
  // Rank 1: Nestling
  {
    ...
    minPoints: 0,
    maxPoints: 49,
    flavorText: "Day 1 at the Ralph S. O'Connor Center. You tangled your feet in the electric sensor cord, your oversized mask slipped down over your beak, and your first lunge hit a water fountain—but your rookie spirit is 100% undefeated!",
    unlockedPerk: 'Rookie Pass: Access to campus-adjacent Charles Village starter quests & freshman study maps.',
